...
This is a fork of SpecFlow (http://www.specflow.org) to facilitate building the ShapDevelop add-in for Ranorex Studio.
For more information about getting Ranorex ready for BDD, have a look at the blog post "How to use Ranorex Studio in your BDD process" (https://www.ranorex.com/blog/how-to-use-ranorex-studio-in-your-bdd-process). 
